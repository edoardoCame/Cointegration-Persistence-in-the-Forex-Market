...
*   **Methodology**:
    *   Uses **OLS (Ordinary Least Squares)** to determine the Hedge Ratio ($\beta$).
...
*   **Output**: Results saved to `../results/daily_cointegration_results_gpu.pkl`
...
*   **Output**: Results saved to `../results/persistence_v2_fixed_beta.pkl`
